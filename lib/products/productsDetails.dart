    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          ...
          style: TextStyle(fontSize: 20, fontFamily: 'SF-Pro-Text-Bold', color: Colors.black, fontWeight: FontWeight.w800),
        ),
      ),
      body: ListView(
        children: [
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(
                                  '$quantity',
                                  style: TextStyle(color: Colors.white, fontSize: 16, fontFamily: "SF-Pro-Text-Bold", fontWeight: FontWeight.w700),
                                ),
                                IconButton(
