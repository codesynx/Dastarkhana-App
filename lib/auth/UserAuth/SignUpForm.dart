                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            "Аккаунтыңыз бар ма? ",
                            style: TextStyle(fontFamily: "SF-Pro-Text-Semibold", fontWeight: FontWeight.w600),
                          ...
                          InkWell(
                            ...
                            child: Text(
                              " Кіру",
                              style: TextStyle(color: disabledButtonColor, fontFamily: "SF-Pro-Text-Semibold", fontWeight: FontWeight.w600),
                              textAlign: TextAlign.center,
                            ),
  ...
  Widget _buildTextFormField({
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        hintText: hintText,
        hintStyle: TextStyle(fontSize: 13, fontFamily: 'SF-Pro-Text-Regular', fontWeight: FontWeight.w300),
