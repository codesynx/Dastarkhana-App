  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          "Профильді жаңарту",
          style: TextStyle(fontFamily: 'SF-Pro-Text-Bold', fontSize: 20, fontWeight: FontWeight.w800),
        ),
      ),
      body: _isLoading
            ...
            child: Column(
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(fontFamily: "SF-Pro-Text-Bold", fontSize: 22, fontWeight: FontWeight.w800),
                ),
                SizedBox(height: 30),
                TextFormField(
